...
HD_PWD='D:/VIVADO-VIVI/SAFE_BOX/SAFE_BOX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MainSys.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MainSys.tcl
