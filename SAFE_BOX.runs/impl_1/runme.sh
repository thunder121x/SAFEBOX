...
HD_PWD='D:/VIVADO-VIVI/SAFE_BOX/SAFE_BOX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MainSys.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MainSys.tcl -notrace
